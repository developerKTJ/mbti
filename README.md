...
### 프로젝트의 시작: MBTI 질문 목록에서 실제 서비스 구현까지
>MBTI 질문 목록을 JavaScript 배열에 저장하고 반복문을 사용하여 출력하는 것으로부터 시작된 이 프로젝트는,\
>이벤트 처리를 효과적으로 수행하면 실제 서비스를 구현할 수 있다는 확신으로부터 필요한 기능들을 하나씩 추가하게 되었고,\
>마침내 메일링 서비스까지 통합하여 구현하였습니다.\
>제대로 된 계획 없이 필요한 기능을 그때그때 추가하다 보니 코딩하는 데 어려움을 겪었고,\
>이 프로젝트를 통해 설계의 중요성을 깨닫게 된 계기가 되었습니다.
